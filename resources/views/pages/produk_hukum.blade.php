    ...
    <div class="container">
      ...
      <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb custom-breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Data Produk Hukum</li>
        </ol>
      </nav>
      ...
      <div class="row justify-content-between align-items-center mb-4 g-3 text-center text-md-start">
        <div class="col-md-7 animate__animated animate__fadeInLeft">
          ...
          <h1 class="section-title-pro mb-2">Data Produk Hukum</h1>
          <p class="section-subtitle-custom">Daftar keterbukaan data Produk Hukum.</p>
        </div>
      ...
      <div class="glass-card bento-card border-0 p-0 overflow-hidden animate__animated animate__fadeInUp">
        <div class="table-responsive">
          <table class="table custom-executive-table mb-0" id="produkHukumTable">
            <thead>
              <tr>
            ...
            <tbody>
                ...
                @else
                  ...
                  <tr id="noDataRow" style="display: none;">
                      <td colspan="5" class="text-center py-4 text-muted">Data atau tahun yang Anda cari tidak ditemukan</td>
                  </tr>
                @endif
                ...
                <tr class="data-row">
                    ...
                    <td class="searchable-cell">
                        <span class="fw-bold text-darkblue d-block document-title">{{ $item['produk_hukum'] }}</span>
                    ...
                    <td class="fw-bold text-muted document-kategori">{{ $item['kategori']['kategori_produk_hukum'] }}</td>
                    <td class="text-center">
                        <div class="d-flex justify-content-center gap-2">
                          @if(!empty($item['file_produk_hukum']))
                            <button type="button" 
                              class="btn btn-sm btn-action-view btn-preview-trigger" 
                              data-bs-toggle="modal" 
                              data-bs-target="#pdfPreviewModal" 
                              data-url="{{ env('API_STORAGE') . $item['file_produk_hukum'] }}" 
                              data-title="{{ $item['produk_hukum'] }}"
                              title="Pratinjau Dokumen">
                              <i class="fa-solid fa-eye"></i>
                            </button>
                            
                            <a href="{{ env('API_STORAGE') . $item['file_produk_hukum'] }}" 
                              download="{{ $item['produk_hukum'] }}" 
