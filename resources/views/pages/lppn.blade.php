    ...
    <div class="container">
      ...
      <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb custom-breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Data LPPN</li>
        </ol>
      </nav>
      ...
      <div class="row justify-content-between align-items-center mb-4 g-3 text-center text-md-start">
        <div class="col-md-7 animate__animated animate__fadeInLeft">
          ...
          <h1 class="section-title-pro mb-2">Data LPPN</h1>
          <p class="section-subtitle-custom">Daftar keterbukaan data LPPN untuk publik.</p>
        </div>
      ...
      <div class="glass-card bento-card border-0 p-0 overflow-hidden animate__animated animate__fadeInUp">
        <div class="table-responsive">
          <table class="table custom-executive-table mb-0" id="lppnTable">
            <thead>
              <tr>
            ...
            <tbody>
                ...
                @foreach ($data['lppn'] as $item)
                <tr class="data-row">
                    <td class="text-center fw-bold text-muted row-number">{{ $loop->iteration }}</td>
                    <td class="searchable-cell">
                        <span class="fw-bold text-darkblue d-block document-title">{{ $item['judul_lppn'] }}</span>
                        ...
                        <div class="d-flex justify-content-center gap-2">
                          @if(!empty($item['file']))
                            <button type="button" 
                              ...
                              data-title="{{ $item['judul_lppn'] }}"
                              title="Pratinjau Dokumen">
                              <i class="fa-solid fa-eye"></i>
                            </button>
                            
                            <a href="{{ env('API_STORAGE') . $item['file'] }}" 
                              download="{{ $item['judul_lppn'] }}" 
