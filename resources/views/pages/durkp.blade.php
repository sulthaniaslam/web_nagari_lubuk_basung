    ...
    <div class="container">
      ...
      <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb custom-breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Data DURKP</li>
        </ol>
      </nav>
      ...
      <div class="row justify-content-between align-items-center mb-4 g-3 text-center text-md-start">
        <div class="col-md-7 animate__animated animate__fadeInLeft">
          ...
          <h1 class="section-title-pro mb-2">Data DURKP</h1>
          <p class="section-subtitle-custom">Daftar keterbukaan data DURKP untuk publik.</p>
        </div>
      ...
      <div class="glass-card bento-card border-0 p-0 overflow-hidden animate__animated animate__fadeInUp">
        <div class="table-responsive">
          <table class="table custom-executive-table mb-0" id="durkpTable">
            <thead>
              <tr>
