    ...
    <div class="container">
      ...
      <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb custom-breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Data LPJ</li>
        </ol>
      </nav>
      ...
      <div class="row justify-content-between align-items-center mb-4 g-3 text-center text-md-start">
        <div class="col-md-7 animate__animated animate__fadeInLeft">
          ...
          <h1 class="section-title-pro mb-2">Data LPJ</h1>
          <p class="section-subtitle-custom">Daftar keterbukaan data LPJ untuk publik.</p>
        </div>
        ...
        <div class="table-responsive">
          <table class="table custom-executive-table mb-0" id="lpjTable">
            ...
            <tbody>
                ...
                @foreach ($data['lpj'] as $item)
                <tr class="data-row">
                    <td class="text-center fw-bold text-muted row-number">{{ $loop->iteration }}</td>
                    <td class="searchable-cell">
                        <span class="fw-bold text-darkblue d-block document-title">{{ $item['judul_lpj'] }}</span>
                        ...
                        <div class="d-flex justify-content-center gap-2">
                          @if(!empty($item['file']))
                            <button type="button" 
                              ...
                              data-title="{{ $item['judul_lpj'] }}"
                              title="Pratinjau Dokumen">
                              <i class="fa-solid fa-eye"></i>
                            </button>
                            
                            <a href="{{ env('API_STORAGE') . $item['file'] }}" 
                              download="{{ $item['judul_lpj'] }}" 
